...
5/27 - Expressions now have their value printed as well. 
5/27 - Since we don't have multiline editting, hard to test things like funcdef and classdef... maybe look at using new pyrepl, it works from python 3.13...
